 ...
 * @type {string}
 */
export declare type StringDateType = `${YearPrefix}${Digit}${Digit}-${Month}-${DayPrefix}${Digit}`;
/**
 * @type {string}
 */
export declare type StringDate = `${YearPrefix}${Digit}${Digit}-${Month}-${DayPrefix}${Digit}`;
